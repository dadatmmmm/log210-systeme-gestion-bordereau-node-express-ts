...
exports.requireJwtMiddleware = exports.SECRET = void 0;
var Decode_1 = require("./Decode");
var CheckExpiration_1 = require("./CheckExpiration");
var Encode_1 = require("./Encode");
exports.SECRET = "rggvnecenDE3308";
function requireJwtMiddleware(request, response, next) {
    ...
    var decodedSession = (0, Decode_1.decodeSession)(exports.SECRET, token);
    ...
    if (expiration === "grace") {
        ...
        var _a = (0, Encode_1.encodeSession)(exports.SECRET, decodedSession.session), token_1 = _a.token, expires = _a.expires, issued = _a.issued;
